	...
	<div class="container clearfix ht-auto">
		<div class="col-md-middle">
			<div class="breadcrumb">
				<a href="/">首页</a> >
				<a href="/zhuanlan/{{ $data['question']->column->cname }}">{{ $data['question']->column->cname }}</a>
			</div>
			<h2>{{ $data['question']->title }}</h2>
			<div class="item-userbar item-userbar-q bor-bot">
				<a href="#" class="tag tag-origin">{{ $data['question']->original ? '原创':'转载' }}</a>
			...
			<div class="col-md-right-s">
				...
				<div class="card-content">
					<ul class="card-ul">
			    		...
			    		<li class="card-li"><a href="/a/{{ $s['id'] }}">{{ $s['title'] }}</a></li>
			    		@endforeach						
					</ul>
				</div>				
			</div>
		...
		<div class="comment-wrap col-md-middle clearfix ht-auto" id="comment-wrap">
			...
			<div class="body-mac body-mac-comment" style="background-color: #fff !important;">
				<!--<div class="comment clearfix ht-auto">
					<div class="comment-logo">
						<img src="/static/images/userLogo/moren.png" />
					</div>
					<div class="comment-body">
						<div class="comment-body-header">
							<a href="" id="username">问问</a>
							<span class="comment-date">2018年10月19日18:10:32</span>
						</div>		
